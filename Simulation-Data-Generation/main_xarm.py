...
robot_id = p.loadURDF("/home/aniruth/Desktop/RRC/XARM7/xArm-Python-SDK/example/wrapper/airobot/src/airobot/urdfs/xarm7_robot.urdf")
...
"""
# https://pybullet.org/Bullet/phpBB3/viewtopic.php?t=12590 to change to background color !
"""



# with open("../Droid Mask Extraction/RLDS_Data/scene_14/cart_pos.txt", "r") as file:
#     for line in file:
#         positions.append(eval(line.strip()))


with open("../Droid Mask Extraction/RLDS_Data/scene_17/cart_pos.txt", "r") as file:
    for line in file:
        # Split the line into separate values based on tabs or spaces and convert them to floats
...
def save_images(rgb_images, mask_images, start_num, rgb_folder="rgb_images_xarm", mask_folder="mask_images_xarm"):
...
scene - 17
"""
camera_position = [0.246533,	0.592491	,0.288275]
camera_orientation = p.getQuaternionFromEuler([-1.98066,	-0.00783103	,-2.47334])
